...
android {
    namespace = "com.chartboost.mediation.unityadsadapter"
    compileSdk = 33
    ...
    defaultConfig {
        ...
        android.defaultConfig.versionName = System.getenv("VERSION_OVERRIDE") ?: "4.4.11.2.0"
...
dependencies {
    ...
    // Partner SDK
    implementation("com.unity3d.ads:unity-ads:4.11.2")
    ...
    publishing {
        publications {
            register<MavenPublication>("remoteRelease") {
                ...
                pom {
                    name.set("Chartboost Mediation Adapter Unity Ads")
